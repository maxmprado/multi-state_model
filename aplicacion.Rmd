...
Para este estudio consideraremos únicamente dos modelos: Modelo No Parámetrico y Modelo Semi-paramétrico. Sin embargo, en ambos casos se considera un modelo de riesgos estratificados.

En el primer modelo, como mencionamos en capítulos anteriores, no haremos uso de las covariables, servirá unicamente para ver las probabilidades de transición de un estado a otro según las edades bajo el supuesto de que las carácterísticas de todas las personas en observación no son significativas.
...
plot(pt0, ord = ord, xlab = "Edad", ylab = "Probabilidad",las = 1, type = "filled")
```
